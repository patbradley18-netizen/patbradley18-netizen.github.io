...
- **[The time capsule](ember-capsule_2026-06-15.html)** — a sealed copy carrying all seven
  frozen language specs, the project charter, the build story, and the 53-program
...
grows (53 programs as of ember 4.4, reaching back to the first release). It runs against all
...
The full record — seven frozen language specs, the project charter, the build story, and the
whole corpus — rides inside [the time capsule](ember-capsule_2026-06-15.html). Open it and
